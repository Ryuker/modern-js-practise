...
class LinkedList {
  ...
  insertFirst(value) {
    ...
    newNode.next = this._head;  // point next to the head node of the list
    this._head = newNode;       // set the head
    this._length++;             // increase the length
  }
  ...
  // Remove at index
  removeAt(index) {
    console.log(index, this._length);
